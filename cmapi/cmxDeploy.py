    ...
    if cdh.get_service_type(service_type) is None:
        ...
        for rcg in [x for x in service.get_all_role_config_groups()]:
            if rcg.roleType == "NAMENODE":
                ...
                rcg.update_config({"dfs_name_dir_list": "/mnt/data0/dfs/nn",
            ...
            if rcg.roleType == "SECONDARYNAMENODE":
                ...
                rcg.update_config({"fs_checkpoint_dir_list": "/mnt/data0/dfs/snn",
            ...
            if rcg.roleType == "DATANODE":
                ...
                rcg.update_config({"datanode_java_heapsize": "127926272",
                                   "dfs_data_dir_list": "/mnt/data0/dfs/dn",
        ...
        for rcg in [x for x in service.get_all_role_config_groups()]:
            ...
            if rcg.roleType == "NODEMANAGER":
                ...
                rcg.update_config({"yarn_nodemanager_heartbeat_interval_ms": "100",
                                   "yarn_nodemanager_local_dirs": "/mnt/data0/yarn/nm",
    ...
    if cdh.get_service_type(service_type) is None:
        ...
        for rcg in [x for x in service.get_all_role_config_groups()]:
            if rcg.roleType == "JOBTRACKER":
                ...
                rcg.update_config({"jobtracker_mapred_local_dir_list": "/mnt/data0/mapred/jt",
            ...
            if rcg.roleType == "TASKTRACKER":
                ...
                rcg.update_config({"tasktracker_mapred_local_dir_list": "/mnt/data0/mapred/local",
        ...
        for rcg in [x for x in service.get_all_role_config_groups()]:
            if rcg.roleType == "IMPALAD":
                rcg.update_config({"impalad_memory_limit": "618659840",
                                   ...
                                   "scratch_dirs": "/mnt/data0/impala/impalad"})
...
def setup_hdfs_ha():
    ...
    try:
        ...
        if len(hdfs.get_roles_by_type("NAMENODE")) != 2:
            ...
            role_group.update_config({"dfs_journalnode_edits_dir": "/mnt/data0/dfs/jn"})
...
def enable_kerberos():
    ...
    if cmx.api_version >= 11:
        check.status_for_command("Configure Kerberos for Cluster v11",
